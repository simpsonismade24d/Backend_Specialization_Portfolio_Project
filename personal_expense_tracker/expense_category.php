...
if(isset($_POST['submit']) && !empty($_POST['amount']) && !empty($_POST['expense_category_name'])){  
    ...
    $sql = "SELECT expense_category_name  FROM expense_category WHERE expense_category_name = '$expense_category_name' ";
  ...
  header('expense_category.php');
		...
		$data = mysqli_query($con, "INSERT INTO expense_category(expense_category_name, created_at, amount) VALUES('".$expense_category_name."', '".$created_at."','".$amount."')");
		}	
...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0; background-color:#FDCC46; color:#FF0">
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <a   href="homepage.php" ><i class="fa fa-dashboard fa-3x"></i><?php echo "$username";?></a>
                      ...
                      <li  >
                        <?php
                      echo" <li><a  href='homepage.php'><i class='fa fa-keyboard-o fa-2x'></i>Expense</a></li>";
                      ?>
 ...
 ?>          
    ...
    <div class="content">
       ...
       <input type="text" name="expense_category_name" id="expense_category_name" class="form-control" placeholder="Enter Expense Name"  required>
                     </div>
              ...
              <div class="form-group col-md-12">
                <label> Enter Amount : </label>
                  <input type="text" name="amount" id="amount"  class="form-control"placeholder="Enter Expense Amount"   onBlur="this.value=trim(this.value);" required>
        </div>
       </div>
    ...
    <!-- </div> -->
        ...
        <?php
					$sql = mysqli_query($con, "SELECT * FROM expense_category order by expense_category_name ASC");
